...
def moch_yayan():
    ...
    print '%s╠══[10]%s Cek Opsi %sCp/Ok%s'%(O,N,O,N);time.sleep(0.04)
    print '%s╠══[0]%s Keluar (%sAhh Ngecrot%s)'%(O,N,M,N);time.sleep(0.04)
    ...
    if pepek == '':
        ...
        print '\n%s╚══[%s•%s] Menu [%s%s%s] Gak Ada Kentod'%(N,M,N,M,pepek,N);time.sleep(3);moch_yayan()
...
def cek_hasil():
    ...
    for memek in buka_baju:
        ...
        print("")
    print("")
    print('%s╔══[%s•%s] %s Cek Hasil Selesai'%(O,P,O,P))
    print('%s║'%(O))
...
def seting_yntkts():
    ...
    ytbjts = raw_input('\n%s[%s?%s] menu : '%(N,O,N))
    if ytbjts == '':
        print '%s╚══[%s•%s] Gak boleh kosong Kentod'%(N,M,N);time.sleep(2);seting_yntkts()
    elif ytbjts =='1':
        yo_ndak_tau_ko_tanya_saia()
    elif ytbjts =='2':
        check_yntkts()
    else:
        print '%s╚══[%s•%s] Isi Yang Bener'%(N,M,N);time.sleep(2);seting_yntkts()
...
def yo_ndak_tau_ko_tanya_saia():
    ...
    if anjng == '':
        print '%s╚══[%s•%s] Gak boleh kosong Kentod'%(N,M,N);yo_ndak_tau_ko_tanya_saia()
    try:
...
class __crack__:
    ...
    def plerr(self):
        try:
            ...
            print '%s╠══[%s×%s] File [%s%s%s] Gak Ada Kentod'%(N,M,N,M,self.apk,N);time.sleep(2)
            raw_input('%s╚══[ %sKEMBALI%s ]'%(N,O,N));moch_yayan()
        ...
        if ___yayanganteng___ in ('Y', 'y'):
            ...
            while True:
                ...
                if pwek == '':
                    ...
                    print '%s╚══[%s•%s] Katasandi Minimal 6 Karakter'%(N,M,N)
                else:
                    def __yan__(ysc=None): # ycs => Yayan sayang Cindy:3
                        ...
                        if cin == '':
                            ...
                            print '\033[0;96m╠══[%s•%s\033[0;96m] \033[0;97mAkun \033[0;92mOK \033[0;97msaved in > \033[0;92mresults/OK-%s-%s-%s.txt'%(O,N,ha, op, ta)
                            print '\033[0;96m╠══[%s•%s\033[0;96m] \033[0;97mAkun \033[0;93mCP \033[0;97msaved in > \033[0;93mresults/CP-%s-%s-%s.txt'%(O,N,ha, op, ta)
                            print '\033[0;96m╚══[%s!%s\033[0;96m] \033[0;97mMode pesawatkan 5 detik setelah crack dimulai..\n'%(M,N)
                            ...
                            print '\033[0;96m╠══[%s•%s\033[0;96m] \033[0;97mAkun \033[0;92mOK \033[0;97msaved in > results/OK-%s-%s-%s.txt'%(O,N,ha, op, ta)
                            print '\033[0;96m╠══[%s•%s\033[0;96m] \033[0;97mAkun \033[0;93mCP \033[0;97msaved in > results/CP-%s-%s-%s.txt'%(O,N,ha, op, ta)
                            print '\033[0;96m╚══[%s!%s\033[0;96m] \033[0;97mMode pesawatkan 5 detik setelah crack dimulai\n'%(M,N)
                            with YayanGanteng(max_workers=30) as (__yayanXD__):
                                for ikeh in self.id:
                                    try:
                    ...
                    print '%s║%s '%(O,N)
                    print '%s╠══[1]%s Metode \033[0;93mB-Api \033[0;97mV1 \033[0;96m[User Agent Nokia]'%(O,N)
                    print '%s╠══[2]%s Metode \033[0;93mB-Api \033[0;97mV2 \033[0;96m[User Agent Vivo]'%(O,N)
                    print '%s╠══[3]%s Metode \033[0;93mMbasic \033[0;97mV1 \033[0;96m[User Agent Oppo]'%(O,N)
                    print '%s╠══[4]%s Metode \033[0;93mMbasic \033[0;97mV2 \033[0;96m[User Agent Asus]'%(O,N)
                    print '%s╠══[5]%s Metode \033[0;93mMobile Fb \033[0;96m[User Agent Windows]'%(O,N)
                    print '%s║%s '%(O,N)
                    __yan__(pwek.split(','))
                    break  
    ...
    def __api__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            try:
            	...
            	_kontol = 'Mozilla/5.0 (Linux; Android 4.1.2; Nokia_X Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.87.90 Mobile Safari/537.36 NokiaBrowser/1.0,gzip(gfe)","NokiaC5-00/061.005 (SymbianOS/9.3; U; Series60/3.2 ;]'
            ses = requests.Session()
    ...
    def __pler__(self):
        ...
        if yan == '':
            ...
            print '%s╠══[%s•%s] Isi Yang Bener'%(N,M,N);self.__pler__()
