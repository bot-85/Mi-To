...
def masuk():
    ...
    if rom in(""):
        ...
        if nanya in(""):
        	...
        	print ("\n%s [√] selamat anda pintar "%(M);jjeda(2);os.system("xdg-open https://youtube.com/channel/UCqwjydkaE3y0qo-3Yl3yL3A');masuk()
        elif nanya in("n","N"):
...
def menu():
    ...
    try:
        ...
        print("%s [!] Waduh token invalid cukk "%(M));jeda(2);os.system('rm -rf data/token.txt && rm -rf data/cookies');masuk()
    except requests.exceptions.ConnectionError:
